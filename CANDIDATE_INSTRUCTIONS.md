...
docker-compose up -d
# or
docker run -d --name fitsloth-postgres -p 5432:5432 -e POSTGRES_USER=fitsloth -e POSTGRES_PASSWORD=fitsloth_secret -e POSTGRES_DB=fitsloth_exam postgres:15-alpine
